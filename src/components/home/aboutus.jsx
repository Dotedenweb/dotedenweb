...
function CirclePerfil(){
        ...
        return (
            <>
            <div className="absolute top-24 left-2/4 layer w-[210px] h-[210px] border border-white rounded-full z-10" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className="absolute top-56 left-14 layer w-[190px] h-[190px] border border-white rounded-full z-10" data-aos="fade-down" data-aos-duration="1000">
...
function RightText(){
    ...
    return(
       ...
       <div className="wrapper">
        ...
        <h2 className='text-8xl text-white font-black relative z-10' data-aos="fade-right">Sobre Nosotros</h2>
        <p className="clonetext textstroke text-8xl font-black -top-5 -left-7 absolute opacity-45 z-0">Sobre Nosotros</p>
        </div>      
      <p className='text-xl text-white relative z-10'  data-aos="fade-right" data-aos-delay="100">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Amet laboriosam, provident deserunt, excepturi quae obcaecati quibusdam iste, labore praesentium consequatur veritatis repudiandae repellat soluta in pariatur. Ipsam sint repudiandae fugit!</p>
       </div>
    )
}
